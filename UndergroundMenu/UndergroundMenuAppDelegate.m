//
//  UndergroundMenuAppDelegate.m
//  A proof of concept menu application using Core Data and Location Services.
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"UndergroundMenu" withExtension:@"momd"];
